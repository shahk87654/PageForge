...
import { HeroSection } from "./(marketing)/_sections/Hero";
import { LogoStripSection } from "./(marketing)/_sections/LogoStrip";
import { HowItWorksSection } from "./(marketing)/_sections/HowItWorks";
import { FeaturesSection } from "./(marketing)/_sections/Features";
import { TestimonialsSection } from "./(marketing)/_sections/Testimonials";
import { PricingSection } from "./(marketing)/_sections/Pricing";
import { FAQSection } from "./(marketing)/_sections/FAQ";
